...
function saklarRuang() {
    ...
    let toggleRuangKeluarga = document.getElementById("default-toggleRuangKeluarga");
    let toggleRuangMakan = document.getElementById("default-toggleRuangMakan");
    let toggleRuangTidur = document.getElementById("default-toggleRuangTidur");
    let toggleRuangTamu = document.getElementById("default-toggleRuangTamu");
    ...
    if (toggleRuangKeluarga.checked) {
        lampu1.src = "assets/images/on.gif";
        lampu2.src = "assets/images/on.gif";
        lampu3.src = "assets/images/on.gif";
    } else {
    ...
    if (toggleRuangMakan.checked) {
        lampu4.src = "assets/images/on.gif";
    } else {
        lampu4.src = "assets/images/off.gif";
    }
    if (toggleRuangTidur.checked) {
        lampu5.src = "assets/images/on.gif";
        lampu6.src = "assets/images/on.gif";
    } else {
        lampu5.src = "assets/images/off.gif";
